...
Este projeto é uma aplicação web para gerenciamento de clientes, permitindo operações CRUD (Create, Read, Update, Delete) com persistência de dados utilizando JPA/Hibernate.
...
│   │       └── ProjetoClientesApplication.java
│   └── resources/
